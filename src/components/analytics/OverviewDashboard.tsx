...
import {
  ...
  Target, Calendar, Globe, MessageSquare,
...
export function computeStats(profiles: ProfileRow[]): Stats {
...
export default function OverviewDashboard({ stats, contactCount }: { stats: Stats; contactCount: number }) {
  ...
  return (
    <div className="space-y-8">
      ...
      >
        ...
        <MetricCard
          icon={Target} label="Retention 30д" value={`${retentionRate}%`}
