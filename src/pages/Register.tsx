      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div>
            ...
            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} className={inputClass} placeholder="Минимум 6 символов" required minLength={6} />
          </div>
          <Button variant="hero" type="submit" className="mt-4 w-full" disabled={loading}>
